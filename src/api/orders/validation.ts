...
export interface OrderJsonResponseObj {
  ...
  [OrderJsonKeys.details_json]: (
    | {
        [OrderJsonKeys.DetailsJson
          .entry_type]: typeof OrderJsonKeys['DetailsJson']['EntryType']['meal'];
        ...
        [OrderJsonKeys.DetailsJson.MealEntry.choices]: {
          ...
          [OrderJsonKeys.DetailsJson.MealEntry.Choice
            .chosen_product_name]: string;
        }[];
      }
    | {
        [OrderJsonKeys.DetailsJson
          .entry_type]: typeof OrderJsonKeys['DetailsJson']['EntryType']['product'];
        [OrderJsonKeys.DetailsJson.quantity]: number;
    ...
    oneOf: [
      {
        ...
        required: ['entry_type', 'product_name', 'product_price', 'quantity'],
      },
      {
        type: 'object',
        properties: {
          ...
          choices: {
            ...
            items: {
              ...
              required: ['category_name', 'chosen_product_name'],
            },
          },
        },
        required: [
...
export const orderResponseObjValidator = new ajv({ allErrors: true }).compile(

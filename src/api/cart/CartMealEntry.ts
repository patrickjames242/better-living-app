...
export class CartMealEntry {
    ...
    static parse(apiResponseObj: CartMealEntryJsonResponseObj) {
        ...
        assertValidObjFromApi(cartMealEntryResponseObjValidator, 'CartMealEntry', apiResponseObj);
    ...
    constructor(id: string, dateCreated: moment.Moment, quantity: number, mealId: number, choices: List<CartMealEntryChoice>) {
        this.id = id;

...
export const cartProductEntryResponseObjValidator = new ajv({
  allErrors: true,
}).compile(CartProductEntryAPIResponseSchema);

export const cartMealEntryResponseObjValidator = new ajv({
  allErrors: true,
}).compile(CartMealEntryAPIResponseSchema);

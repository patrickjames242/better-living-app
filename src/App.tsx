...
if (Platform.OS === 'web') {
  window.document.body.style.backgroundColor =
    CustomColors.mainBackgroundColor.stringValue;
}
    ...
    () => ({
      initialAppScreen: (() => {
        ...
        switch (params.get('initialTabSelection')) {
          case 'todaysMenu': {
            const x: { type: InitialAppScreenType.todaysMenu } = {
              type: InitialAppScreenType.todaysMenu,
            };
            return x;
          }
          case 'healthTips': {
            const x: { type: InitialAppScreenType.healthTips } = {
              type: InitialAppScreenType.healthTips,
            };
            return x;
          }

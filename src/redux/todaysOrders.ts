...
export function updateAllOrdersAction(
  allOrders: List<Order>,
): UpdateAllOrdersAction {
  return {
...
export function insertOrUpdateOrderAction(
  order: Order,
): InsertOrUpdateOrderAction {
  return {
...
export type TodaysOrdersActions =
  | UpdateAllOrdersAction
  | InsertOrUpdateOrderAction
  | LogOutAction;
...
export function todaysOrdersReducer(
  state: TodaysOrdersState = Map(),
  action: TodaysOrdersActions,
): TodaysOrdersState {
  switch (action.type) {

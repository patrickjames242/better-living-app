...
const ActionStrings = nestReduxActionStrings({
    ...
    cart: {
        REPLACE_CART_PRODUCT_AND_MEAL_ENTRIES: 'UPDATE_CART_PRODUCT_AND_MEAL_ENTRIES',
        
        INSERT_OR_UPDATE_PRODUCT_ENTRY: 'INSERT_OR_UPDATE_PRODUCT_ENTRY',
        INCREMENT_PRODUCT_ENTRY_PENDING_QUANTITY_CHANGE: 'INCREMENT_PRODUCT_ENTRY_PENDING_QUANTITY_CHANGE',
        DELETE_PRODUCT_ENTRY: 'DELETE_PRODUCT_ENTRY',

        INSERT_OR_UPDATE_MEAL_ENTRY: 'INSERT_OR_UPDATE_MEAL_ENTRY',
        INCREMENT_MEAL_ENTRY_PENDING_QUANTITY_CHANGE: 'INCREMENT_MEAL_ENTRY_PENDING_QUANTITY_CHANGE',

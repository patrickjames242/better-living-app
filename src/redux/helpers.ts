...
export function nestReduxActionStrings<_ActionStringsObject extends ActionStringsObject>(actionsObj: _ActionStringsObject): _ActionStringsObject{
	...
	(object: _ActionStringsObject, prefix?: string): _ActionStringsObject{

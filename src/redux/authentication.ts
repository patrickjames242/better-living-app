...
export type SetAuthStateAction = CustomReduxAction<{
  state: AuthenticationState;
}>;

export function setAuthStateAction(
  state: AuthenticationState,
): SetAuthStateAction {
  return {
...
export type LogInOrSignUpAction = CustomReduxAction<{
  authToken: string;
  userObject: User;
}>;

export function logInOrSignUpAction(
  authToken: string,
  userObject: User,
): LogInOrSignUpAction {
  return {

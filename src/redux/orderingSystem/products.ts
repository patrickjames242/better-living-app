...
export function updateAllProductsAction(allProducts: List<Product>): UpdateAllProductsAction{
    return {
...
export type ProductsActions = UpdateAllProductsAction | InsertOrUpdateProductAction | DeleteProductAction


export function productsReducer(state = Map<number, Product>(), action: ProductsActions){

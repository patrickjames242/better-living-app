...
export default function TipsDetailAudioPlayer(props: {
  ...
  function updateState(
    transformer: (
      oldState: TipsDetailAudioPlayerState,
    ) => TipsDetailAudioPlayerState,
  ) {
  ...
  function updatePlayableState(
    newPlayableState: TipsDetailAudioPlayerPlayableState,
  ) {
      ...
      const playableState: TipsDetailAudioPlayerPlayableState = (() => {
        if (status.isPlaying) {
          ...
          const shouldBeLoading =
            ...
            (status.durationMillis ?? NaN) <= 0;
          return shouldBeLoading
            ? TipsDetailAudioPlayerPlayableState.loading
            : TipsDetailAudioPlayerPlayableState.notPlayingButReadyToPlay;
        }
      })();

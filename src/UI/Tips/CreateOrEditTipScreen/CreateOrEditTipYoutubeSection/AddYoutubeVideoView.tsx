...
const AddYoutubeVideoView = (() => {
  ...
  const AddYoutubeVideoView = (props: AddYoutubeVideoViewProps) => {
    ...
    const shouldAddButtonBeEnabled =
      typeof extractVideoId(urlText) === 'string';

    return (
      <TextFieldViewContainer topTitleText="Add New YouTube Video">
        <SpacerView space={10} style={styles.contentHolderView}>
          ...
          <CreateOrEditTipEditButton
            isEnabled={shouldAddButtonBeEnabled}
            buttonType={CreateOrEditTipEditButton_EditButtonType.add}
            onPress={() => {

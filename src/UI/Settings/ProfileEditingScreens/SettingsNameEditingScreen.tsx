...
const SettingsNameEditingScreen = (
  props: StackScreenProps<SettingsNavStackParams, 'NameEditing'>,
) => {
            ...
            longButtons={[
              {
                ...
                isEnabled:
                  ...
                  (formik.initialValues.firstName.trim() !==
                    ...
                    formik.initialValues.lastName.trim() !==
                      formik.values.lastName.trim()),
              },
            ]}
          >
            <FormikTextFieldView<NameEditingValues>

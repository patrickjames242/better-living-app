...
const SettingsChangePasswordScreen = (
  props: StackScreenProps<SettingsNavStackParams, 'ChangePassword'>,
) => {
            ...
            longButtons={[
              {
                ...
                isEnabled:
                  formik.isValid &&
                  formik.dirty &&
                  formik.initialValues.newPassword.trim() !==
                    formik.values.newPassword.trim(),
              },
            ]}
          >
            <FormikTextFieldView<ChangePasswordValues>
              topTitleText="New Password"

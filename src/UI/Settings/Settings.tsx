...
const Settings = () => {
  return (
    ...
    >
      ...
      <SettingsNavStack.Screen
        name="MealCategoriesList"
        component={MealCategoriesListScreen}
      />

      <SettingsNavStack.Screen
        name="ProductEditOrCreate"
        component={ProductEditOrCreationScreen}
      />
      <SettingsNavStack.Screen
        name="MealCategoryEditOrCreate"
        component={MealCategoryEditOrCreationScreen}
      />
      <SettingsNavStack.Screen
        name="ProductsPicker"
        component={OrderingSystemEditingProductsPickerScreen}
      />
      <SettingsNavStack.Screen
        name="MealEditOrCreate"
        component={MealEditOrCreationScreen}
      />
      <SettingsNavStack.Screen
        name="MealCategoriesPicker"
        component={OrderingSystemEditingMealCategoriesPickerScreen}
      />
      <SettingsNavStack.Screen
        name="MenuEditOrCreate"
        component={MenuEditOrCreationScreen}
      />
      ...
      <SettingsNavStack.Screen
        name="NameEditing"
        component={SettingsNameEditingScreen}
      />
      <SettingsNavStack.Screen
        name="PhoneNumberEditing"
        component={SettingsPhoneNumberEditingScreen}
      />
      <SettingsNavStack.Screen
        name="EmailEditing"
        component={SettingsEmailEditingScreen}
      />
      <SettingsNavStack.Screen
        name="ChangePassword"
      ...
      <SettingsNavStack.Screen
        name="AllowOrderingSwitch"
        component={AllowOrderingSwitchScreen}
      />
      <SettingsNavStack.Screen
        name="OrderingSystemMoreSettings"
        component={OrderingSystemMoreSettingsScreen}
      />
      <SettingsNavStack.Screen
        name="EditVatPercentageScreen"
        component={EditVatPercentageScreen}
      />
      <SettingsNavStack.Screen

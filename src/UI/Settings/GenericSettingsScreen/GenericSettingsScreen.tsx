  ...
  const styles = StyleSheet.create({
    ...
    sectionListContentContainer: {
      ...
      maxWidth:
        ...
        LayoutConstants.pageSideInsets * 2,
      alignSelf: 'center',
      width: '100%',
    },
    sectionHeader: {
      ...
      <View style={styles.root}>
        ...
        <SectionList<SettingsItemViewProps>
          ...
          contentContainerStyle={[
            ...
            props.sectionListProps?.contentContainerStyle,
          ]}
          keyExtractor={(_, index) => String(index)}
          renderSectionHeader={args => {
            if (args.section.title == null) {
              return null;
            }
            return (
              <CustomizedText style={styles.sectionHeader}>
                {args.section.title}
              </CustomizedText>
            );
          }}
          SectionSeparatorComponent={(args: SectionSeparatorComponentInfo) => {
            const spaceSize = (() => {
              if (args.leadingItem != null && args.trailingSection != null) {
                ...
                return LayoutConstants.floatingCellStyles

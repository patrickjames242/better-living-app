...
import GenericSettingsScreen, {
  ...
  GenericSettingsScreenNavigationBarType,
...
const SettingsListScreen = (
  props: StackScreenProps<SettingsNavStackParams, 'SettingsList'>,
) => {
  const authentication = useSelector(state => state.authentication);
  const isEmployeeOrManager = [UserType.employee, UserType.manager].includes(
    authentication?.userObject.userType ?? UserType.customer,
  );

  const profileSettingsItems = useUserProfileSettingsItems();
  const isOrderingSystemEnabled = useSelector(
        ...
        ? [
            {
              ...
              data: [
                  ...
                  ? [
                      {
                        ...
                        rightSubtitleText: (() => {
                          ...
                          else if (isOrderingSystemEnabled === false)
                            return 'Off';
                ...
                },
                {
                  ...
                  onPress: () => {
                    props.navigation.push('MenusList');
                  },
                },
                {
                  title: 'Meals',
                  ...
                  onPress: () => {
                    props.navigation.push('MealsList');
                  },
                },
                {
                  ...
                  onPress: () => {
                    props.navigation.push('MealCategoriesList');
                  },
                },
                {
                  ...
                  onPress: () => {
                    props.navigation.push('OrdersHistory');
                  },
                },
                  ...
                  ? [
                      {
                        ...
                        onPress: () => {
                          props.navigation.push('OrderingSystemMoreSettings');
                        },
                      },
                    ]
                  : []),
  ...
  if (authentication == null) {
    ...
    return (
      <GenericSettingsScreen
        ...
        sectionListProps={{
          ListHeaderComponent: authentication
            ? () => (

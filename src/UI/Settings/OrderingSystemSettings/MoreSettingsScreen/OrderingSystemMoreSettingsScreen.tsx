...
const OrderingSystemMoreSettingsScreen = (
  props: StackScreenProps<SettingsNavStackParams, 'OrderingSystemMoreSettings'>,
) => {
  ...
  const sections: GenericSettingsScreenSection[] = useMemo(() => {
    return [
      {
        ...
        data: [
          allowOrderingSwitchSettingsItem,
          {
            ...
            onPress: () => {
              props.navigation.push('EditDeliveryFee');
            },
          },
          {
            ...
            onPress: () => {
              props.navigation.push('EditVatPercentageScreen');
            },
          },
        ],
      },
    ...
    globalSettings.vatPercentage,
    props.navigation,
  ]);
  return <GenericSettingsScreen navBarTitle="More" sections={sections} />;
};

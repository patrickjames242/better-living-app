...
import {
  ...
  updateProduct,
  deleteProduct,
} from '../../../../../api/orderingSystem/products/requests';
...
const ProductEditOrCreationScreen = (() => {
  function submitForm(
    values: ProductEditOrCreateValues,
    initialValues: ProductEditOrCreateValues,
    ...
    const setImage: RNFileForUpload | null | undefined = (() => {
      if (values.imageSource?.fileToUpload instanceof RNFileForUpload) {
        ...
        values.imageSource?.fileToUpload === null &&
        initialValues.imageSource !== null
      ) {
        return null;
      } else {
        return undefined;
  ...
  const ProductEditOrCreationScreen = (
    props: StackScreenProps<SettingsNavStackParams, 'ProductEditOrCreate'>,
  ) => {
    ...
    return (
      <Formik<ProductEditOrCreateValues>
        ...
        onSubmit={(values, { setSubmitting }) => {
          submitForm(values, initialValues, props.route.params.productId)
            .finally(() => {
              setSubmitting(false);
            })
            .then(() => {
      ...
      >
        {formik => {
          ...
          return (
            ...
            >
              <FormikTextFieldView<ProductEditOrCreateValues>
              ...
              <FormikMultilineTextFieldView<ProductEditOrCreateValues>

...
export interface OrderingSystemItemPickerScreenProps<Item extends OrderingSystemItem>{
    navBarTitle: string;
...
const OrderingSystemItemPickerScreen = (() => {
    ...
    const OrderingSystemItemPickerScreen = function<Item extends OrderingSystemItem>(props: OrderingSystemItemPickerScreenProps<Item>){
        ...
        const sections: SectionType[] = useMemo(() => {
            ...
            return x;
        }, [items.selected, items.unselected, props.selectedSectionTitleText, props.unselectedSectionTitleText]);
        ...
        return <View style={styles.root}>
            ...
            <FloatingCellStyleList<Item, SectionType>
                ...
                renderItem={({ item }) => {
                    return <ListItemView item={item} isSelected={selectedIds.contains(item.id)} onSelectButtonPressed={() => {

...
import SelectableRoundedTextButton, {
  SelectableRoundedTextButtonProps,
} from '../SelectableRoundedTextButton';
...
export interface OrderingSystemFormSelectableTagsChooserFieldProps<
  ItemIdType extends string | number,
> {
...
const OrderingSystemFormSelectableTagsChooserField = (() => {
  ...
  const OrderingSystemFormSelectableTagsChooserField = function <
    ItemIdType extends string | number,
  >(props: OrderingSystemFormSelectableTagsChooserFieldProps<ItemIdType>) {
    return (
      <TextFieldViewContainer topTitleText={props.containerTopTitleText}>
              ...
              <TagItemView
                ...
                onPress={() => {
                  if (props.selectedItemIds.contains(item.id)) {
                    props.onSelectedItemsDidChange(
                      props.selectedItemIds.remove(item.id),
                    );
                  } else {
                    props.onSelectedItemsDidChange(
                      props.selectedItemIds.add(item.id),
                    );
                  }
                }}
              />

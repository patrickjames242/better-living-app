...
const LogInPopUp = (() => {
  ...
  const LogInPopUp: React.ForwardRefRenderFunction<
    LogInPopUpRef,
    LogInPopUpProps
  > = (props, ref) => {
    ...
    const navigation =
      useNavigation<
        NavigationProp<RootNavigationViewParams, 'MainInterface'>
      >();
          ...
          >
            <View style={styles.innerPopUpContainer}>
              ...
              <CustomizedText style={styles.subtitleText}>
                In order to access this feature, you need to create an account
                or log in.
              </CustomizedText>
              <Space space={20} />
              <LongTextAndIconButton
                ...
                text="Log In"
                onPress={() => {
                  navigation.navigate('LogInSignUpUI', {
                    initialScreen: 'LogIn',
                  });
                  setPresented(false);
                }}

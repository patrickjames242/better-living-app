...
const ForgotPasswordScreen = (
  props: StackScreenProps<LogInSignUpUIParams, 'ForgotPassword'>,
) => {
  ...
  return (
    <Formik
      ...
      onSubmit={(values, { setSubmitting }) => {
        ...
        sendForgotMyPasswordVerificationCode(email)
          .finally(() => {
            setSubmitting(false);
          })
          .then(() => {
            props.navigation.push('ForgotPasswordVerificationCode', {
              email: email,
    ...
    >
      {formik => {
        return (
          ...
          >
            <FormikTextFieldView<ForgotPasswordFormValues>
              topTitleText="Email"

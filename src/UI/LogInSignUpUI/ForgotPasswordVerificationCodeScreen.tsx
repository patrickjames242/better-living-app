  ...
  return (
    <Formik
      ...
      onSubmit={(values, { setSubmitting }) => {
        ...
        testVerificationCodeValidity(props.route.params.email, verificationCode)
          .finally(() => {
            setSubmitting(false);
          })
          .then(() => {
            props.navigation.push('ForgotPasswordCreateNewPassword', {
              email: props.route.params.email,
              verificationCode: verificationCode,
              onPasswordChanged: props.route.params.onPasswordChanged,
            });
          })
          .catch(error => {
    ...
    >
      {formik => {
        return (
          ...
          >
            <FormikTextFieldView<VerificationCodeFormValues>
              topTitleText="Verification Code"
              formikFieldName="verificationCode"
              textInputProps={{

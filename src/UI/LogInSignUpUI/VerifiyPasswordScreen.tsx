...
const VerifyPasswordScreen = () => {
  const navigation =
    useNavigation<
      CompositeNavigationProp<
        StackNavigationProp<LogInSignUpUIParams, 'VerifyPassword'>,
        StackNavigationProp<RootNavigationViewParams>
      >
    >();
  ...
  return (
    <Formik
      ...
      onSubmit={(values, { setSubmitting }) => {
        testPasswordValidity(values.password)
          .finally(() => {
            setSubmitting(false);
          })
          .then(() => {
    ...
    >
      {formik => {
        return (
          ...
          >
            <FormikTextFieldView<VerifyPasswordValues>
            ...
            <ForgotPasswordButton
              onForgottenPasswordChanged={(_, password) => {
                switch (route.params.purpose) {
                  case VerifyPasswordPurpose.forPasswordChange:
                    break;
                  default:

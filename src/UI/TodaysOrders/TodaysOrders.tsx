...
const TodaysOrders = () => {
  return (
    <TodaysOrdersNavStack.Navigator
      initialRouteName="TodaysOrdersList"
      screenOptions={DEFAULT_NAV_SCREEN_OPTIONS}
    >
      <TodaysOrdersNavStack.Screen
        name="TodaysOrdersList"
        component={TodaysOrdersListScreen}
      />
      <TodaysOrdersNavStack.Screen
        name="OrderDetail"
...
export default React.memo(TodaysOrders);

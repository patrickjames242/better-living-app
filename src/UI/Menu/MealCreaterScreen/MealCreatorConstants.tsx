...
const MealCreatorConstants = {
  foodSections: {
    ...
    sectionHeaderBottomSpacing:
      LayoutConstants.floatingCellStyles.sectionHeaderBottomSpacing,
    contentViewPadding: LayoutConstants.floatingCellStyles.padding,
    imageHeightPercentageOfWidth:
    ...
    get rowHeight() {
      return (
        this.contentViewPadding * 2 +
        this.imageHeightPercentageOfWidth * this.imageWidth
      );
    },

    sectionHeight(numOfRows: number) {
      return (
        this.sectionHeaderTextStyles.fontSize * 1.2 +
        this.sectionHeaderBottomSpacing +
        this.rowHeight * numOfRows
      );
    },
  },
};

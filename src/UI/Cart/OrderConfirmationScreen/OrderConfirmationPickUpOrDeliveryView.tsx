...
const OrderConfirmationPickUpOrDeliveryView = (() => {
  ...
  const OrderConfirmationPickUpOrDeliveryView = (
    props: OrderConfirmationPickUpOrDeliveryViewProps,
  ) => {
    ...
    return (
      <FloatingCellStyleSectionView
        sectionTitle="Pick Up or Delivery"
        style={styles.root}
      >
        <Spacer
        ...
        >
          <OrderConfirmationSelectableOptionView
            ...
            isSelected={
              formikContext.values.pickUpOrDelivery === PickUpOrDelivery.pickUp
            }
            onCheckMarkPressed={() =>
          ...
          <OrderConfirmationSelectableOptionView
            ...
            title={[
              ...
              ...(deliveryFee > 0
                ? [`(adds ${currency(deliveryFee).format()})`]
                : []),
            ].join(' ')}
            isSelected={
              formikContext.values.pickUpOrDelivery ===
          ...
          />
          {formikContext.values.pickUpOrDelivery ===
            PickUpOrDelivery.delivery && <DeliveryDirections />}
        </Spacer>
      </FloatingCellStyleSectionView>
    );
  };

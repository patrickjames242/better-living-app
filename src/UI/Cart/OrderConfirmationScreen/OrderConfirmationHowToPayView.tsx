...
const OrderConfirmationHowToPayView = (() => {
    ...
    const OrderConfirmationHowToPayView = (props: OrderConfirmationHowToPayViewProps) => {
        ...
        const payOnArrivalIsEnabled = formikContext.values.pickUpOrDelivery !== PickUpOrDelivery.delivery;
        const payOnlineIsEnabled = orderConfirmationScreenContext.isOnlinePaymentAllowed;
        ...
        return <FloatingCellStyleSectionView sectionTitle="Pay In Person or Online" style={styles.root}>
            <Spacer space={OrderConfirmationLayoutConstants.selectableOptionViewSpacing}>
                <OrderConfirmationSelectableOptionView
                    ...
                    errorMessage={payOnArrivalIsEnabled === false ? 'Payment in person is not allowed for deliveries. Please pay online.' : undefined}
                />
                <OrderConfirmationSelectableOptionView
                    ...
                    errorMessage={payOnlineIsEnabled === false ? Platform.select({
                        web: 'Online payment is not available at this time 😞  . But it will be available soon 😆  !!',
                        default: 'Online payment is not available at this time 😞 . But it will be available soon 😆 !!'

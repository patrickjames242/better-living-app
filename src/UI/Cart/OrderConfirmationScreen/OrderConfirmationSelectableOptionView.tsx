...
const OrderConfirmationSelectableOptionView = (() => {
  ...
  const OrderConfirmationSelectableOptionView = (
    props: OrderConfirmationSelectableOptionViewProps,
  ) => {
    ...
    return (
      <TextFieldViewContainer errorMessage={props.errorMessage}>
        <SpacerView
        ...
        >
          ...
          <CheckMarkButton
            ...
            onPress={props.onCheckMarkPressed}
            hitSlop={checkMarkButtonHitSlop}
          />
        </SpacerView>

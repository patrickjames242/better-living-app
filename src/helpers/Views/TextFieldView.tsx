...
export const MultilineTextFieldView = (props: TextFieldViewProps) => {
  return (
    <TextFieldViewContainer
      style={props.style}
      topTitleText={props.topTitleText}
      errorMessage={props.errorMessage}
      {...props.textFieldContainer}
    >
      <MultilineTextFieldTextInput
...
export interface TextFieldViewContainerProps
...
export const TextFieldViewContainer = (() => {
  ...
  const TextFieldViewContainer = (props: TextFieldViewContainerProps) => {
    return (
      <SpacerView {...props} style={[styles.root, props.style]} space={10}>
        ...
        {typeof props.errorMessage === 'string' &&
          props.errorMessage.trim().length > 0 && (
            <CustomizedText style={styles.errorText}>
              {props.errorMessage}
            </CustomizedText>
          )}
      </SpacerView>
...
export const MultilineTextFieldTextInput = (() => {
  const MultilineTextFieldTextInput: React.ForwardRefRenderFunction<
    TextInput,
    TextFieldTextInputProps
  > = (props, ref) => {
    return (
      <TextFieldTextInput
        ref={ref}
        returnKeyType={
          props.returnKeyType ??
          (Platform.select({ web: 'enter', default: 'default' }) as any)
        }
...
export const TextFieldTextInput = (() => {
  ...
  const TextFieldTextInput: React.ForwardRefRenderFunction<
    TextInput,
    TextFieldTextInputProps
  > = (props, ref) => {
    ...
    return (
      <TextInput
        ...
        selectionColor={
          props.selectionColor ?? CustomColors.themeGreen.stringValue
        }
        placeholderTextColor={
          props.placeholderTextColor ?? Color.gray(0.7).stringValue
        }
        ...
        style={[
          styles.textInput,
          {
            borderColor: isActive
              ? LayoutConstants.forms.textFieldSelectionOutline.color.selected
              : props.inactiveBorderColor ??
                LayoutConstants.forms.textFieldSelectionOutline.color
                  .unselected,
          },
          props.style,
        ]}
